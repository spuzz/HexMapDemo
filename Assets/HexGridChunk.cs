...
public class HexGridChunk : MonoBehaviour
{
...
)
    {
        ...
        else
        {
            ...
            terrain.AddTriangleColour(color1, color2, color3);
            Vector3 types;
    ...
    )
    {
        ...
        terrain.AddTriangleColour(color1, c3, c4);
        terrain.AddTriangleTerrainTypes(types);
        ...
        terrain.AddQuadColour(c3, c4, color2, color3);
        terrain.AddQuadTerrainTypes(types);
    }
    ...
    )
    {
        ...
        else
        {
            ...
            terrain.AddTriangleColour(color2, color3, boundaryColor);
            terrain.AddTriangleTerrainTypes(types);
        }
    }
    ...
    )
    {
        ...
        terrain.AddTriangleColour(beginColor, c2, boundaryColor);
        terrain.AddTriangleTerrainTypes(types);
        ...
        terrain.AddTriangleColour(c2, leftColor, boundaryColor);
        terrain.AddTriangleTerrainTypes(types);
    }
