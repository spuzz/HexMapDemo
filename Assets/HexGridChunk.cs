...
public class HexGridChunk : MonoBehaviour
{
...
)
    {
        ...
        else
        {
            ...
            terrain.AddTriangleColour(bottomCell.Color, leftCell.Color, rightCell.Color);
        }
    ...
    )
    {
        ...
        terrain.AddTriangleColour(beginCell.Color, c3, c4);
        ...
        terrain.AddQuadColour(c3, c4, leftCell.Color, rightCell.Color);
    }
    ...
    )
    {
        ...
        else
        {
            ...
            terrain.AddTriangleColour(leftCell.Color, rightCell.Color, boundaryColor);
        }
    }
    ...
    )
    {
        ...
        terrain.AddTriangleColour(beginCell.Color, c2, boundaryColor);
        ...
        for (int i = 2; i < HexMetrics.terraceSteps; i++)
        {
            ...
            terrain.AddTriangleColour(c1, c2, boundaryColor);
        }

        terrain.AddTriangleUnPerturbed(v2, HexMetrics.Perturb(left), boundary);
        terrain.AddTriangleColour(c2, leftCell.Color, boundaryColor);
    }
    ...
    )
    {
        ...
        terrain.AddQuadColour(cell.Color);
